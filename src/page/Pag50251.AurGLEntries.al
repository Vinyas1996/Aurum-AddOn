page 50251 "Aur_GLEntries"
{
    ApplicationArea = all;
    UsageCategory = Lists;
    Caption = 'AGT GLEntries';
    Editable = false;
    PageType = List;
    ...
    layout
    {
        area(Content)
        {
            repeater(GroupName)
            {
                ...
                {
                    ToolTip = 'Specifies the value of the MEM IC Settlement field.', Comment = '%';
                }
                field(BssiCurrencyFactor; Rec.BssiCurrencyFactor)
                {
                    ToolTip = 'Specifies the value of the Currency Factor field.', Comment = '%';
                }
                field(BssiDuetoDuefrom; Rec.BssiDuetoDuefrom)
                {
                    ToolTip = 'Specifies the value of the Dueto Duefrom Lines field.', Comment = '%';
                }
                field(BssiEntityID; Rec.BssiEntityID)
                {
                    ToolTip = 'Specifies the value of the MEM Entity ID field.', Comment = '%';
                }
                field(BssiICDestEntity; Rec.BssiICDestEntity)
                {
                    ToolTip = 'Specifies the value of the MEM Destination Entity for IC Lines field.', Comment = '%';
                }
                field(BssiReportAmount; Rec.BssiReportAmount)
                {
                    ToolTip = 'Specifies the value of the Report Amount field.', Comment = '%';
                }
                field(BssiSourceCurrencyAmount; Rec.BssiSourceCurrencyAmount)
                {
                    ToolTip = 'Specifies the value of the Source Currency Amount field.', Comment = '%';
                }
                field(BssiSourceCurrencyCode; Rec.BssiSourceCurrencyCode)
                {
                ...
                {
                    ToolTip = 'Specifies the value of the GST/HST field.', Comment = '%';
                }
